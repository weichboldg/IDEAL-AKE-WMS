...
/// <summary>
/// Tests fuer den neuen 2-Rollen-Composite-Filter aus Phase 2 Task 7 (v1.12.0).
/// Picking ODER Leitstand -> Zugriff auf PickingLeitstandController erlaubt.
/// </summary>
public class RequirePickingOrLeitstandAccessFilterTests
{
    ...
    public async Task PickingOnly_AllowsAccess()
    {
        ...
        var filter = new RequirePickingOrLeitstandAccessFilter(currentUserService.Object);
