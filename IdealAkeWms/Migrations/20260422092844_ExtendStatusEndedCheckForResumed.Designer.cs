...
namespace IdealAkeWms.Migrations
{
    ...
    [Migration("20260422092844_ExtendStatusEndedCheckForResumed")]
    partial class ExtendStatusEndedCheckForResumed
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IdealAkeWms.Models.BdeBooking", b =>
                {
                    ...
                    b.ToTable("BdeBookings", "dbo", t =>
                        {
                            t.HasCheckConstraint("CK_BdeBookings_StatusEnded", "([Status] = 1 AND [EndedAt] IS NULL) OR ([Status] IN (2,3,4) AND [EndedAt] IS NOT NULL)");
