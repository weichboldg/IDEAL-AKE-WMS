...
namespace IdealAkeWms.Migrations
{
    ...
    [Migration("20260529074719_AddIsFinalShortageToWarehouseRequisitionItems")]
    partial class AddIsFinalShortageToWarehouseRequisitionItems
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IdealAkeWms.Models.OseonWorkOperation", b =>
                {
                    ...
                    b.HasIndex("OseonProductionOrderId", "OseonStatus", "Name")
            ...
            modelBuilder.Entity("IdealAkeWms.Models.ProductionOrderBdeStatus", b =>
                {
                    ...
                    b.ToTable("ProductionOrderBdeStatus", "dbo");
                });

            modelBuilder.Entity("IdealAkeWms.Models.ProductionOrderPickingStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("IsReleasedForPicking")
                    ...
                    b.ToTable("ProductionOrderPickingStatus", "dbo");
                });
            ...
            modelBuilder.Entity("IdealAkeWms.Models.WarehouseRequisition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("WarehouseRequisitions", "dbo");
                });

            modelBuilder.Entity("IdealAkeWms.Models.WarehouseRequisitionItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("WarehouseRequisitionId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("WarehouseRequisitionId", "ArticleNumber")
                        .IsUnique();

                    b.HasIndex("WarehouseRequisitionId", "Position");

                    b.ToTable("WarehouseRequisitionItems", "dbo");
                });
            ...
            modelBuilder.Entity("IdealAkeWms.Models.ProductionOrderBdeStatus", b =>
                {
                    b.HasOne("IdealAkeWms.Models.ProductionOrder", "ProductionOrder")
                        .WithOne("BdeStatus")
                        .HasForeignKey("IdealAkeWms.Models.ProductionOrderBdeStatus", "ProductionOrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("IdealAkeWms.Models.ProductionOrderPickingStatus", b =>
                {
                    ...
                    b.HasOne("IdealAkeWms.Models.ProductionOrder", "ProductionOrder")
                        .WithOne("PickingStatus")
                        .HasForeignKey("IdealAkeWms.Models.ProductionOrderPickingStatus", "ProductionOrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("IdealAkeWms.Models.WarehouseRequisitionItem", b =>
                {
                    b.HasOne("IdealAkeWms.Models.WarehouseRequisition", "WarehouseRequisition")
                        .WithMany("Items")
                        .HasForeignKey("WarehouseRequisitionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("WarehouseRequisition");
                });
